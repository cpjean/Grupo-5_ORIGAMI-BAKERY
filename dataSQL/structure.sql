...
CREATE TABLE `dhproyect`.`type_product` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id`));

/*==========creacion de categoryUser=========*/
CREATE TABLE `dhproyect`.`category_user` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(50) NOT NULL,
  PRIMARY KEY (`id`));

/*==========creacion de lot product=========*/
CREATE TABLE `dhproyect`.`lot_product` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(50) NOT NULL,
  PRIMARY KEY (`id`));

/*==========creacion de medio de pago=========*/
CREATE TABLE `dhproyect`.`medios_de_pago` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(50) NOT NULL,
  PRIMARY KEY (`id`));

/*==========creacion de user e implementando FK=========*/
CREATE TABLE `dhproyect`.`users` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(50) NOT NULL,
...
/*==========creacion de product=========*/
CREATE TABLE `dhproyect`.`products` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(50) NOT NULL,
...
CREATE TABLE `dhproyect`.`compra` (
  ...
  CONSTRAINT `FK_medio`
    FOREIGN KEY (`id_pago`)
    REFERENCES `dhproyect`.`medios_de_pago` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_user`
    FOREIGN KEY (`id_user`)
...
CREATE TABLE `dhproyect`.`carrito` (
  `id` INT NOT NULL AUTO_INCREMENT,
